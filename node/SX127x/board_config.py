...
class BOARD:
    ...
    DIO0 = 4#22   # RaspPi GPIO 22
    DIO1 = 23#23   # RaspPi GPIO 23
    DIO2 = 24#24   # RaspPi GPIO 24
    DIO3 = 21#25   # RaspPi GPIO 25
    LED  = 18#18   # RaspPi GPIO 18 connects to the LED on the proto shield
    SWITCH = 7#4  # RaspPi GPIO 4 connects to a switch
